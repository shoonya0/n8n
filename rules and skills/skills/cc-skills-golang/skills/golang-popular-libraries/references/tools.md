...
**golangci-lint** (https://github.com/golangci/golangci-lint) Fast Go linters runner. Runs multiple linters in parallel, highly configurable, industry standard for Go code quality.
